...
import Portafolio.Portafolio.DAO.RutaPermitDao;
import Portafolio.Portafolio.service.RutaPermitService;
...
@Service
public class RutaPermitImpl  implements RutaPermitService {
     @Autowired
